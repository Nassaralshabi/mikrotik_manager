...
class mik
{
    ...
    var $timeout   = 3;    // 3 Connection attempt timeout and data read timeout 
    var $attempts  = 5;     //  Connection attempt count
    var $delay     = 3;     // 3 Delay between connection attempts in seconds
     ...
     * by Njeeb Murad
     **/
     public function where($comm,$name,$w)
     {
         $this->write($comm,false);
         $this->write("?".$name."=".$w);
         return $this->read(); 
     }
}